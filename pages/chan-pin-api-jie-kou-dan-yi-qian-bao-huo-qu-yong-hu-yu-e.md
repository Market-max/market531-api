...
`POST` `{`**`ACCESS_URL`**`}/api/balance/get_balance?trace_id=minigame_trace_id`
...
---
来源：https://docs.mini.game/cc/chan-pin-api-jie-kou/dan-yi-qian-bao/huo-qu-yong-hu-yu-e
