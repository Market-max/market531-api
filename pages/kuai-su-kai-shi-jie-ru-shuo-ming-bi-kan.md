...
* 文档中`{`**`POLY_APIURL`**`}`需替换为在商户后台界面提供的测试/生产环境接口调用地址，查看`商户运营后台-设定-API接入配置- **POLY_APIURL** ，POLY提供给接入方的接口。
...
| 类型            | 值                                                                                                                                                                    |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 请求url         | {**`POLY_APIURL`**}/api/Balance/GetBalance?trace\_id=dhf1aboc1iio                                                             |
| 请求方式          | POST                                                                                                                                                                 |
