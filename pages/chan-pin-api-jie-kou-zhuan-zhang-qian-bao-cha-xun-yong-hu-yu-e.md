...
| `token`     | string  | 用户在MINI.GAME平台的token,可以通过[获取玩家鉴权token接口](/cc/chan-pin-api-jie-kou/zhuan-zhang-qian-bao/huo-qu-yong-hu-jian-quan-token.md)获得 |
...
| —-   | balance  | Yes | decimal | <p>余额(最多支持4位小</p><p>数)</p>                                          |
...
---
来源：https://docs.mini.game/cc/chan-pin-api-jie-kou/zhuan-zhang-qian-bao/cha-xun-yong-hu-yu-e
