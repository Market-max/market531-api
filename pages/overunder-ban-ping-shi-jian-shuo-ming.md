...
| `bets.balance.balance`        | number | 余额                                                                                                                                                                          |
| `bets.balance.currency`       | string | 余额货币类型                                                                                                                                                                      |
| `bets.bets[key1][key2].bet`   | number | <p>key1:区域编号<br>1:点数;2:点数和;3:大小;4:单双;5:围骰;6:长牌;7:短牌;</p><p><br>key2:区域索引<br>点数：1-6；点数和：4-17；大小：1小2大；单双：1单2双；围骰：0-6(0表示任意三重)；长牌：1-15；短牌：1-6；<br><br>bet:注数</p>               |
| `bets.bets[key1][key2].multi` | number | <p>key1:区域编号<br>1:点数;2:点数和;3:大小;4:单双;5:围骰;6:长牌;7:短牌;</p><p><br>key2:区域索引<br>点数：1-6；点数和：4-17；大小：1小2大；单双：1单2双；围骰：0-6(0表示任意三重)；长牌：1-15；短牌：1-6；<br><br>multi:倍数(投注阶段只是占位数据)</p> |
...
---
来源：https://docs.mini.game/cc/overunder-ban-ping-shi-jian-shuo-ming
